      ...
      items: [
        {
          ...
          color: "#3B82F6",
          onPress: () => router.push("/auth/settings/profile"),
        },
        {
          id: "alterar-senha",
          title: "Alterar Senha",
          ...
          color: "#10B981",
          onPress: () => router.push("/auth/settings/password"),
        },
        {
          id: "privacidade",
          title: "Privacidade",
      ...
      items: [
        {
          ...
          color: "#3B82F6",
          onPress: () => router.push("/auth/settings/company"),
        },
        {
          id: "contas",
          title: "Contas",
          ...
          color: "#F59E0B",
          onPress: () => router.push("/auth/settings/accounts"),
        },
      ],
    },
    {
      ...
      items: [
        {
          ...
          color: "#8B5CF6",
          onPress: () => router.push("/auth/settings/plans"),
        },
        {
          id: "historico",
          ...
          color: "#10B981",
          onPress: () => router.push("/auth/settings/payment-history"),
        },
      ],
    },
    {
